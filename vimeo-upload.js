 ...
 */
 ...
 (function(root, factory) {
     ...
     - offset (int),
     - privacyView (string), privicy setting
     - chunkSize (int),
     ...
     */
      ...
      * added param
      * @param {string} [options.privacyView] view privacy ( anybody - contacts - disable - nobody - password - unlisted - users)
      */
